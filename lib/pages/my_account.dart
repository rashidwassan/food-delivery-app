      ...
      child: Column(
        children: [
          buildNewProductsAndVendorsAppbar(
              height: 45, title: Strings.myAccount),
          16.heightBox,
          Expanded(
            child: ListView(
              shrinkWrap: true,
              children: [
                ...
                12.heightBox,
                _buildProfileScreenRow(
                    icon: Images.profileDeliveryAddress,
                    title: Strings.deliveryAddresses,
                    onTap: () {
                      Navigator.pushReplacementNamed(
                          context, DeliveryAddressesScreen.id);
                    }),
                12.heightBox,
                _buildProfileScreenRow(
    ...
    return Expanded(
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            color: Styling.mainYellow, borderRadius: BorderRadius.circular(10)),
        child: Center(
          child: Text(
            text,
